...
function AdminLogin() {
  ...
  return (
    <div style={{ maxWidth: '400px', margin: '50px auto', padding: '30px', border: '1px solid #ddd', borderRadius: '10px' }}>
      <h2 style={{ textAlign: 'center', color: '#ff6347' }}>Admin Login</h2>
      <form onSubmit={handleSubmit}>
        ...
        <button type="submit" style={{ width: '100%', padding: '10px', backgroundColor: '#ff6347', color: 'white', border: 'none', borderRadius: '5px', cursor: 'pointer' }}>Login</button>
      </form>
      {message && <p style={{ color: 'red', textAlign: 'center' }}>{message}</p>}
      <p style={{ textAlign: 'center', marginTop: '15px' }}>Don't have an account? <Link to="/admin/register">Register</Link></p>
